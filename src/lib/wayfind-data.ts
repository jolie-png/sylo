...
export const OPPORTUNITIES: Opportunity[] = [
  // ===== UCLA — Biology / Physician-Scientist track =====
  {
    ...
    window: "Typical deadline: Mid-November · Verify date",
  },
  {
    id: "op-ucla-bisep",
    ...
    window: "Typical deadline: Early March · Verify date",
  },
  {
    ...
    window: "Typical deadline: Mid-February · Verify date",
  },
  {
    ...
    window: "Typical deadline: Early April · Verify date",
  },
  {
  ...
  // ===== Indiana (Kelley) — Business Analyst track =====
  {
    ...
    window: "Typical deadline: Early February · Verify date",
  ...
  },
  {
    ...
    window: "Typical deadline: Early September · Verify date",
  ...
  },
  {
    ...
    window: "Typical deadline: Mid-January · Verify date",
  ...
  // ===== NYU Stern — Investment Banking track =====
  {
    ...
    window: "Typical deadline: Mid-September · Verify date",
  },
  {
    ...
    window: "Typical deadline: Early October · Verify date",
  },
  {
    id: "op-nyu-simulator",
  ...
  },
  {
    ...
    deadline: "2027-05-15",
    timeframe: "Apply Spring for following Fall (year-long)",
    window: "Typical deadline: Mid-May · Verify date",
  ...
  },
  {
    ...
    window: "Typical deadline: Early January · Verify date",
  ...
  // ===== Georgetown — Political Science / Public Affairs track =====
  {
    ...
    window: "Typical deadline: Early November · Verify date",
  ...
  },
  {
    ...
    window: "Typical deadline: Late September · Verify date",
  ...
  },
  {
    ...
    window: "Typical deadline: Mid-March · Verify date",
